...
path="/home/sujithpk/Desktop/data_new/test3_23.csv"
...
# open the file with sensor data
with open(path) as file:
    # read the csv file
    reader=csv.reader(file)
    # assign to a list variable
    data_sig=list(reader) #data_sig is the list format of csv file
...
def getData(colno):     # colno = column to be read
    ...
    for i in range(3139):
        ac_sig[i] = float(data_sig[i][colno]) / 2.38
